...
MGX_session = "/home/user/Desktop/surface_label_parents.mgxv"
if(sample_type == "LEAF"):
...
for sample_number in sample_list:
    ...
    for filename in os.listdir(mesh_path):
        ...
        if filename.endswith(".mgxm"):
                ...
                lineage_file =locate_A_File([filename[0:5],".csv"],heatmap_path)
                print file_viewfile
                print lineage_file
                # exit()
                if(file_viewfile and lineage_file):
                    ...
                    snap_title = os.path.join(heatmap_path,filename[0:5]+"_lineage_snap.png")
                    print snap_title
