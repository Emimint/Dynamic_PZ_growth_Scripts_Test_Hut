...
output = "Growth_CV_vs_APZ_by_BF_catplot_violinplot_colored_violins" # will be .png 
# ===============================================

out_file_name = os.path.join(dest_path,output+".png")
...
kwargs  =   {'edgecolor':"black", # for edge color
            ...
            'size':1.5 # for dot size
            }

ax = sns.violinplot(x='BF_value', y='Growth', data=File_Info, hue="Zone",inner=None,palette=['royalblue','darkorange'], scale="count",linewidth =0.5)

ax = sns.swarmplot(x="BF_value", y="Growth", data=File_Info, hue="Zone",dodge=True,**kwargs, palette=['grey','grey'], alpha  = 0.8)#violinplot or boxplot
