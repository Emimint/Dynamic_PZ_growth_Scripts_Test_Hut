...
# In_use_df = In_use_df.sort_values('Sample_Primordium')
# print (Data_File)
# exit()
...
for sample_number in sample_list:
    ...
    for primordium in primordia_list:
        ...
        # exit()
        # ax = sns.lineplot(data=In_use_df, x="BF_value", y="Growth",hue="Zone",style="Zone",palette=['black','dimgray',  'silver'], markers=True, dashes=[(2,0),(1,1),(1,2)], legend="full",ci=95,ci="sd")
        ...
        # ax = sns.lineplot(data=new_df, x="BF_value", y="Growth",hue="Zone",style="Zone",palette=['lightblue','coral','yellow'], markers=True, dashes=[(2,0),(1,1),(1,2)], legend="full")
        # out_file_name = os.path.join(dest_path,sample_type+"_"+sample_number +"_"+primordium +"_growth_by_region_vs_boundary_formation_all_samples.png")
