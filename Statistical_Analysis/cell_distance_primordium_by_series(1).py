...
for sample_number in sample_list:
    ...
    # ax = sns.lineplot(data=Data_File, x="BF_value", y="Cell_distance", hue="Primordium",palette=palette, legend="full")

    # plt.show()

    # print estimator
    # exit()
    # out_file_name = os.path.join(dest_path,str(sample_number) +"_"+sample_type+"_sample_boundary_displacement_speed_VS_BF_value_all_primordia.png")
    ...
    # out_file_name = os.path.join(dest_path,str(sample_number) +"_"+sample_type+"_sample_boundary_distance_VS_BF_value_all_primordia.png")
